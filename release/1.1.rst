...
Furthermore this release includes integration with both `Aether ROC <https://docs.aetherproject.org/onramp/roc.html>`_ and
`SD-Fabric P4-UPF <https://opennetworking.org/sd-fabric/>`_ for 5G
...
SD-Core documentation is available at `docs.sd-core.aetherproject.org
<https://docs.sd-core.aetherproject.org>`_
