...
**Webui GET operations**: Add GET operations for DeviceGroups and Network
Slices.
...
**gNBSim**: Add support for retransmit message. Also, add support for statistics
at procedure level and transaction level. Moreover, add E2E latency measurements
